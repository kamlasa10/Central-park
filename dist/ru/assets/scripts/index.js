!(function (e, t) {
  ...
  var f = (function (n) {
    ...
    try {
      O.apply((t = P.call(w.childNodes)), w.childNodes),
    ...
    function we(f, h, v, g, y, e) {
      return (
        ...
        ae(function (e, t, n, i) {
          ...
          } else (p = me(p === t ? p.splice(c, p.length) : p)), y ? y(null, t, p, i) : O.apply(t, p);
        })
      );
    }
    function be(g, y) {
      function e(e, t, n, i, o) {
        ...
        if (((l += c), m && c !== l)) {
          ...
          if (e) {
            if (0 < l) for (; c--; ) d[c] || u[c] || (u[c] = N.call(i));
            u = me(u);
          }
          O.apply(i, u),
            o && !e && 0 < u.length && 1 < l + y.length && re.uniqueSort(i);
        }
        return o && (($ = h), (x = p)), d;
      }
      var m = 0 < y.length,
          ...
          for (n = (t = t || h(e)).length; n--; )
            (r = (function e(t) {
              for (
                ...
                if ((n = b.relative[t[l].type])) u = [ge(ye(u), n)];
                else {
                  if ((n = b.filter[t[l].type].apply(null, t[l].matches))[C]) {
                    for (i = ++l; i < r && !b.relative[t[i].type]; i++);
                    return we(
                      1 < l && ye(u),
                      1 < l &&
                        ve(
      ...
      (v = re.select = function (e, t, n, i) {
        ...
        if (((n = n || []), 1 === d.length)) {
          if (
            ...
            if (!(t = (b.find.ID(s.matches[0].replace(te, u), t) || [])[0]))
              return n;
          ...
          for (
            ...
            if (
              (l = b.find[a]) &&
              (i = l(
                s.matches[0].replace(te, u),
                (ee.test(r[0].type) && fe(t.parentNode)) || t
              ))
            ) {
  ...
  (C.filter = function (e, t, n) {
    ...
    C.fn.extend({
      ...
      is: function (e) {
        return !!D(this, "string" == typeof e && $.test(e) ? C(e) : e || [], !1)
          .length;
      },
    });
  var j,
  ...
  function Oe(n, i, o, r) {
    ...
    if (
      ...
      for (a = (s = C.map(pe(e, "script"), He)).length; d < u; d++)
        (l = e),
          d !== p &&
            ((l = C.clone(l, !0, !0)), a && C.merge(s, pe(l, "script"))),
          o.call(n[d], l, d);
      if (a)
        for (c = s[s.length - 1].ownerDocument, C.map(s, Ne), d = 0; d < a; d++)
          (l = s[d]),
            de.test(l.type || "") &&
              ...
              (l.src && "module" !== (l.type || "").toLowerCase()
                ...
                : b(l.textContent.replace(De, ""), c, l));
    }
    return n;
  }
  function Pe(e, t, n) {
    for (var i, o = t ? C.filter(t, e) : e, r = 0; null != (i = o[r]); r++)
      n || 1 !== i.nodeType || C.cleanData(pe(i)),
        i.parentNode &&
          (n && C.contains(i.ownerDocument, i) && fe(pe(i, "script")),
  ...
  C.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (t)
        if (n)
          for (r = r || pe(e), s = s || pe(d), i = 0, o = r.length; i < o; i++)
            Le(r[i], s[i]);
        else Le(e, d);
      return (
        0 < (s = pe(d, "script")).length && fe(s, !u && pe(e, "script")), d
      );
    },
  ...
  function _e() {
    ...
    Fe &&
      ...
      me.appendChild(Re).appendChild(Fe),
      (e = k.getComputedStyle(Fe)),
      (qe = "1%" !== e.top),
  ...
  function ft() {
    lt &&
      (!1 === S.hidden && k.requestAnimationFrame
        ? k.requestAnimationFrame(ft)
        : k.setTimeout(ft, C.fx.interval),
      C.fx.tick());
  }
  function ht() {
    return (
  ...
  function yt(r, e, t) {
    ...
    for (
      ...
      if ((n = yt.prefilters[i].call(c, r, d, c.opts)))
        return (
          w(n.stop) &&
  ...
  (C.Animation = C.extend(yt, {
        ...
        if ((l = !C.isEmptyObject(t)) || !C.isEmptyObject(f))
          ...
          f))
            l ||
              ...
              v && ae([e], !0),
              p.done(function () {
                for (i in (v || ae([e]), G.remove(e, "fxshow"), f))
                  C.style(e, i, f[i]);
              })),
              (l = gt(v ? g[i] : 0, i, p)),
              i in g ||
    ...
    (ct = S.createElement("input")),
    (dt = S.createElement("select").appendChild(S.createElement("option"))),
    (ct.type = "checkbox"),
    (m.checkOn = "" !== ct.value),
    (m.optSelected = dt.selected),
    ((ct = S.createElement("input")).value = "t"),
    (ct.type = "radio"),
    (m.radioValue = "t" === ct.value);
  var mt,
      ...
      if (
        ...
        for (o = 0; (h = u[o++]) && !e.isPropagationStopped(); )
          (d = h),
            ...
            (l = (G.get(h, "events") || {})[e.type] && G.get(h, "handle")) &&
              l.apply(h, t),
            (l = a && h[a]) &&
              l.apply &&
              Y(h) &&
        ...
        g.hasContent
          ...
          : ((r = g.url.slice(u.length)),
            g.data &&
              ...
              ((u += (jt.test(u) ? "&" : "?") + g.data), delete g.data),
            !1 === g.cache &&
              ((u = u.replace(Mt, "$1")),
              (r = (jt.test(u) ? "&" : "?") + "_=" + Dt++ + r)),
            (g.url = u + r)),
  ...
  C.ajaxSetup({
    ...
    C.each(["top", "left"], function (e, n) {
      C.cssHooks[n] = Ge(m.pixelPosition, function (e, t) {
        if (t)
          return (t = Ve(e, n)), Be.test(t) ? C(e).position()[n] + "px" : t;
      });
    }),
    ...
    (o = 0),
      ...
      (s.prototype.setSlideClasses = function (e) {
        ...
        r.$slides.eq(e).addClass("slick-current"),
          !0 === r.options.centerMode
            ? ((i = r.options.slidesToShow % 2 == 0 ? 1 : 0),
              (o = Math.floor(r.options.slidesToShow / 2)),
              !0 === r.options.infinite &&
                (o <= e && e <= r.slideCount - 1 - o
                  ? r.$slides
                      .slice(e - o + i, e + o + 1)
                ...
                0 === e
                  ...
                  : e === r.slideCount - 1 &&
                    s.eq(r.options.slidesToShow).addClass("slick-center")),
            ...
            : ((n = r.slideCount % r.options.slidesToShow),
              ...
              r.slideCount - e < r.options.slidesToShow
                ? s
                    .slice(t - (r.options.slidesToShow - n), t + n)
                    .addClass("slick-active")
                    .attr("aria-hidden", "false")
                : s
  ...
  (function ($) {
      ...
      $(window).on("scroll", function () {
        ...
        sections.each(function () {
          ...
          if (cur_pos >= top && cur_pos <= bottom) {
            ...
            try {
              window.section = document
                .querySelector(`[data-section-name="${window.currentSection}"]`)
                .getBoundingClientRect().y;
              window.nextSection = document
                .querySelector(`[data-section-name="${window.currentSection}"]`)
                .nextElementSibling.getBoundingClientRect().y;
            } catch {}
    ...
    function sliderView(el, idx) {
      ...
      el.on("init afterChange", (_, slick, currentSlide = 0, nextSlide) => {
        ...
        let titlePrev = wrapNext.find(".view__wrap-title").text();
        let titleNext = wrapPrev.find(".view__wrap-title").text();
        btnNext.html(`${titleNext.slice(0, titleNext.length - 2)}<sup>2</sup>`);
        btnPrev.html(`${titlePrev.slice(0, titlePrev.length - 2)}<sup>2</sup>`);
      });
    ...
    $(".map__item").each(function () {
      ...
      markers2[$(this).find("[data-map]").data("map")] =
        infrastructure[$(this).find("[data-map]").data("map")];
      setMapOnAll(map);
    });
